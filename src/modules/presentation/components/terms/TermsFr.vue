<template>
  <div class="Terms">
    ...
    <section>
      ...
      <p>
        <strong>Prestations et Services :</strong> https://miimber.com met à
      ...
      <ul>
        ...
        <li>
          ...
          susceptibles d’être détenues par https://miimber.com pour la gestion
    ...
    <section>
      ...
      <p>
        ...
        site internet https://miimber.com l'identité des différents intervenants
        dans le cadre de sa réalisation et de son suivi:
      </p>
      <p>
        Propriétaire : Adrien Guinet – 111, avenue Thiers 69006 Lyon
        <br />Responsable publication : Adrien Guinet –
        adrien.guinet@miimber.com <br />Le responsable publication est une
        personne physique ou une personne morale. <br />Webmaster : Adrien
        Guinet – adrien.guinet@miimber.com <br />Hébergeur : Clever-cloud – rue
        de l'Allier 44000 Nantes +33 2 85 52 07 69 <br />Délégué à la protection
        des données : Adrien Guinet – adrien.guinet@miimber.com
      </p>
    </section>
    <section>
      <h2>
      ...
      <p>
        L’utilisation du site https://miimber.com implique l’acceptation pleine
        ...
        complétées à tout moment, les utilisateurs du site https://miimber.com
      ...
      <p>
        ...
        être toutefois décidée par https://miimber.com, qui s’efforcera alors de
        communiquer préalablement aux utilisateurs les dates et heures de
        l’intervention. Le site web https://miimber.com est mis à jour
        régulièrement par https://miimber.com responsable. De la même façon, les
    ...
    <section>
      ...
      <p>
        Le site internet https://miimber.com a pour objet de fournir une
        information concernant l’ensemble des activités de la société.
        https://miimber.com s’efforce de fournir sur le site https://miimber.com
      ...
      <p>
        Toutes les informations indiquées sur le site https://miimber.com sont
        données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs,
        les renseignements figurant sur le site https://miimber.com ne sont pas
    ...
    <section>
      ...
      <p>
        ...
        navigateur de dernière génération mis-à-jour Le site https://miimber.com
      ...
      <p>
        https://miimber.com et l’hébergeur ne pourront être tenus responsables
        en cas de dysfonctionnement du réseau Internet, des lignes téléphoniques
    ...
    <section>
      ...
      <p>
        https://miimber.com est propriétaire des droits de propriété
        ...
        interdite, sauf autorisation écrite préalable de : https://miimber.com.
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        https://miimber.com se réserve également la possibilité de mettre en
    ...
    <section>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Adrien Guinet.
        https://miimber.comest représenté par Adrien Guinet, son représentant
        légal
      </p>
      <p>
        En tant que responsable du traitement des données qu’il collecte,
        https://miimber.com s’engage à respecter le cadre des dispositions
        ...
        https://miimber.com traite des Données Personnelles, https://miimber.com
        ...
        lesquelles https://miimber.com les traite.
      </p>
      <h3>7.2 Finalité des données collectées</h3>
      <p>
        https://miimber.com est susceptible de traiter tout ou partie des
        données :
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          https://miimber.com : adresse email
        </li>
        <li>
      ...
      <p>
        https://miimber.com ne commercialise pas vos données personnelles qui
        sont donc uniquement utilisées par nécessité ou à des fins statistiques
        et d’analyses.
      </p>
      <h3>7.3 Droit d’accès, de rectification et d’opposition</h3>
      <p>
        Conformément à la réglementation européenne en vigueur, les Utilisateurs
        de https://miimber.com disposent des droits suivants :
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          et de choisir à qui https://miimber.com devra communiquer (ou non) ses
          données à un tiers qu’ils aura préalablement désigné
        </li>
      </ul>
      <p>
        Dès que https://miimber.com a connaissance du décès d’un Utilisateur et
        à défaut d’instructions de sa part, https://miimber.com s’engage à
      ...
      <p>
        Si l’Utilisateur souhaite savoir comment https://miimber.com utilise ses
        Données Personnelles, demander à les rectifier ou s’oppose à leur
        traitement, l’Utilisateur peut contacter https://miimber.com par écrit à
        l’adresse suivante :
      </p>
      <p>
        Adrien Guinet – DPO, Adrien Guinet
        <br />111, avenue Thiers 69006 Lyon. <br />Dans ce cas, l’Utilisateur
        doit indiquer les Données Personnelles qu’il souhaiterait que
        https://miimber.com corrige, mette à jour ou supprime, en s’identifiant
      ...
      <p>
        ...
        obligations qui sont imposées à https://miimber.com par la loi,
        notamment en matière de conservation ou d’archivage des documents.
        Enfin, les Utilisateurs de https://miimber.com peuvent déposer une
        réclamation auprès des autorités de contrôle, et notamment de la CNIL
        (https://www.cnil.fr/fr/plaintes).
      </p>
      <h3>7.4 Non-communication des données personnelles</h3>
      <p>
        https://miimber.com s’interdit de traiter, héberger ou transférer les
        ...
        https://miimber.com reste libre du choix de ses sous-traitants
      ...
      <p>
        https://miimber.com s’engage à prendre toutes les précautions
        ...
        https://miimber.com, celle-ci devra dans les meilleurs délais informer
        le Client et lui communiquer les mesures de corrections prises. Par
        ailleurs https://miimber.com ne collecte aucune « données sensibles ».
      </p>
      <p>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de https://miimber.com et des sous-traitants (prestataires de
      ...
      <p>
        ...
        accès aux données des Utilisateurs de https://miimber.com sont
        principalement les agents de notre service client.
      </p>
      <h3>7.5 Types de données collectées</h3>
      <p>
        Concernant les utilisateurs d’un Site https://miimber.com, nous
      ...
      <p>
        https://miimber.com collecte en outre des informations qui permettent
        d’améliorer l’expérience utilisateur et de proposer des conseils
        contextualisés :
        <br />Langue
      </p>
      <p>
        Ces données sont conservées pour une période maximale de 9 mois après la
    ...
    <section>
      ...
      <p>
        ...
        https://miimber.com n'est publiée à l'insu de l'utilisateur, échangée,
        transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
        l'hypothèse du rachat de https://miimber.com et de ses droits
    ...
    <section>
      ...
      <p>
        Le site https://miimber.com contient un certain nombre de liens
        hypertextes vers d’autres sites, mis en place avec l’autorisation de
        https://miimber.com. Cependant, https://miimber.com n’a pas la
      ...
      <p>
        https://miimber.com est susceptible de traiter les informations de
        ...
        https://miimber.com d’améliorer le contenu du Site, de la navigation de
        l’Utilisateur.
      </p>
      <p>
        ...
        d’être enregistré dans son terminal. https://miimber.com informe
      ...
      <p>
        ...
        être le cas lorsque https://miimber.com ou l’un de ses prestataires ne
        peut pas reconnaître, à des fins de compatibilité technique, le type de
      ...
      <p>
        Le cas échéant, https://miimber.com décline toute responsabilité pour
        les conséquences liées au fonctionnement dégradé du Site et des services
        éventuellement proposés par https://miimber.com, résultant (i) du refus
        de Cookies par l’Utilisateur (ii) de l’impossibilité pour
        https://miimber.com d’enregistrer ou de consulter les Cookies
      ...
      <p>
        ...
        modifier ses souhaits en matière de Cookies. https://miimber.com pourra
      ...
      <p>
        ...
        https://miimber.com ou dans son application mobile et si l’Utilisateur a
        accepté le dépôt de cookies en poursuivant sa navigation sur le Site
        Internet ou l’application mobile de https://miimber.com, Twitter,
      ...
      <p>
        ...
        Internet ou l’application mobile de https://miimber.com. À tout moment,
        l’Utilisateur peut néanmoins revenir sur son consentement à ce que
        https://miimber.com dépose ce type de cookies.
      </p>
      <h3>9.2. BALISES (“TAGS”) INTERNET</h3>
      <p>
        https://miimber.com peut employer occasionnellement des balises Internet
      ...
      <p>
        Cette technologie permet à https://miimber.com d’évaluer les réponses
      ...
      <p>
        ...
        https://miimber.com, et fournir d’autres services relatifs à
    ...
    <section>
      ...
      <p>
        Tout litige en relation avec l’utilisation du site https://miimber.com
